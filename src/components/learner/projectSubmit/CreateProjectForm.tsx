...
export const CreateProjectForm = ({
  ...
  formik: FormikProps<SubmitProjectDto>;
    ...
    <section>
      ...
      <div className="flex flex-col xl:flex-row gap-4">
        <div className="flex-1 flex flex-col gap-4">
          <Label htmlFor="projectThaiName" className="block mt-8">
            ชื่อโครงการภาษาไทย
          </Label>
          <Input
            type="text"
          ...
          {formik.touched.projectThaiName && formik.errors.projectThaiName ? (
            <div className="text-red-500 text-sm">
              {formik.errors.projectThaiName}
            </div>
          ) : null}
          <Label htmlFor="projectEngName" className="block">
          ...
          {formik.touched.projectEngName && formik.errors.projectEngName ? (
            <div className="text-red-500 text-sm">
              {formik.errors.projectEngName}
            </div>
          ) : null}

          <Label htmlFor="projectSummary" className="block">
          ...
          <Label>
            โครงการมีเป้าหมายการพัฒนาที่ยั่งยืนด้านใด (Sustainable Development
            Goals : SDGs) *
          </Label>
          <Select
            defaultValue="SDG1"
          ...
          >
            ...
            <SelectContent>
              ...
              <SelectItem value="SDG16">
                SDG16: Peace and Justice Strong Institutions
              </SelectItem>
              <SelectItem value="SDG17">
        ...
        <div className="flex-1 flex flex-col gap-4">
          {!readonly && (
            <>
              <Label htmlFor="projectDescriptionFile" className="block mt-8">
                ไฟล์เอกสารโครงการ
              </Label>
              <Input
                type="file"
                ...
                onChange={async (e: React.ChangeEvent<HTMLInputElement>) => {
                  ...
                  if (file?.size / 1024 / 1024 < 5) {
                    ...
                    toast.error("ไฟล์ต้องมีขนาดน้อยกว่า 5 MB");
                    e.target.value = ""; // Clear the input field on error
                  }
                }}
              />
              {formik.touched.projectDescriptionFile &&
              formik.errors.projectDescriptionFile ? (
                <div className="text-red-500 text-sm">
                  {formik.errors.projectDescriptionFile}
                </div>
              ) : null}
            ...
            <div className="flex flex-col space-x-2 gap-4">
              <div className="flex flex-row gap-4">
                <RadioGroupItem
                  ...
                  disabled={readonly}
                />
                <Label htmlFor="projectType1" className="text-sm">
                  โครงการพัฒนาใหม่
                </Label>
              </div>
              <div className="flex flex-row gap-4">
                ...
                />
                <Label htmlFor="projectType1" className="text-sm">
                  โครงการต่อยอดจากโครงการเดิม
                </Label>
                {hasParentProject && (
                  <div className="flex flex-col gap-4 mt-4">
                    <Label htmlFor="parentProjectID" className="block">
                      เลือกโครงการที่ต้องการพัฒนาต่อยอด
                    </Label>
                    <Select
                      defaultValue=""
                      onValueChange={(value) =>
                        formik.setFieldValue("parentProjectID", value)
                      }
                      disabled={readonly}
          ...
          >
            ...
            <SelectContent>
              <SelectItem value="energy_and_environment">
                พลังงานและสิ่งแวดล้อม
              </SelectItem>
              <SelectItem value="construction_and_infrastructure">
              ...
              <SelectItem value="manufacturing_and_automotive">
                อุตสาหกรรมการผลิตและหุ่นยนต์
              </SelectItem>
              <SelectItem value="electronics_and_retail">
                พาณิชย์อิเล็กทรอนิกส์และค้าปลีก
              </SelectItem>
              <SelectItem value="real_estate_and_urban_development">
                อสังหาริมทรัพย์และการพัฒนาเมือง
              </SelectItem>
              <SelectItem value="media_and_entertainment">
                สื่อและบันเทิง
              </SelectItem>
              <SelectItem value="tourism_and_services">
                การท่องเที่ยวและบริการ
              </SelectItem>
              <SelectItem value="society_and_community">
                สังคมและชุมชน
              </SelectItem>
            </SelectContent>
          </Select>
