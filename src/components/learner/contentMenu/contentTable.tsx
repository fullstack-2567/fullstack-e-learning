  ...
  const mockContents = [
    {
      contentID: "py001",
      contentName:
        "Python ใน 4 ชั่วโมง - คอร์สเรียนเต็มรูปแบบสำหรับผู้เริ่มต้น",
    ...
    },
    {
      ...
      category: "อาหาร",
      contentThumbnail:
        "https://images.unsplash.com/photo-1585032226651-759b368d7246?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80",
      description:
        "เรียนรู้การทำผัดไทยรสชาติกลมกล่อมแบบต้นตำรับ! คอร์สนี้จะสอนทุกขั้นตอน ตั้งแต่การเตรียมเส้นจันท์ คุณภาพสูง การปรุงน้ำปลาร้าสูตรพิเศษ และเทคนิคการผัดไฟแรงให้เส้นไม่ติดกระทะ พร้อมสาธิตการจัดวางหน้าผัดไทยให้สวยงามน่ารับประทาน คอร์สเหมาะสำหรับทั้งมือใหม่และคนที่อยากพัฒนาทักษะการทำอาหารไทยคลาสสิก",
    },
    {
      contentID: "cs502",
    ...
    },
    {
      ...
      description:
        "ทำความเข้าใจโลกของปัญญาประดิษฐ์ด้วยบทนำที่เข้าถึงง่ายเกี่ยวกับการเรียนรู้ของเครื่อง คอร์สนี้อธิบายแนวคิดที่ซับซ้อนในรูปแบบง่ายๆ ครอบคลุมการเรียนรู้ภายใต้การดูแลและไม่มีการดูแล, เครือข่ายประสาทเทียม, และการเรียนรู้เชิงลึก คุณจะได้ประสบการณ์ปฏิบัติกับ TensorFlow, เฟรมเวิร์กการเรียนรู้ของเครื่องอันทรงพลังของ Google ผ่านแบบฝึกหัด ไม่จำเป็นต้องมีความรู้คณิตศาสตร์ขั้นสูง - แค่ความอยากรู้และความเต็มใจที่จะเรียนรู้เกี่ยวกับเทคโนโลยีที่เปลี่ยนแปลงโลกนี้",
    },
    {
      contentID: "calc01",
      contentName:
        "แคลคูลัสใน 12 ชั่วโมง - ทบทวนแนวคิดสำคัญของพีชคณิตและตรีโกณมิติ",
      category: "คณิตศาสตร์",
      contentThumbnail:
        "https://images.unsplash.com/photo-1635070041078-e363dbe005cb?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80",
      description:
        "คอร์สแคลคูลัสแบบเร่งรัดนี้เริ่มต้นด้วยการทบทวนแนวคิดสำคัญของพีชคณิตและตรีโกณมิติก่อนที่จะเข้าสู่ลิมิต, อนุพันธ์, และอินทิกรัล ออกแบบมาสำหรับนักเรียนที่ต้องการทบทวนหรือเรียนรู้แบบเร่งรัด มันแบ่งแนวคิดทางคณิตศาสตร์ที่ซับซ้อนออกเป็นส่วนที่เข้าใจได้ ด้วยคำอธิบายที่ชัดเจนและตัวอย่างการทำงานมากมาย คุณจะมีความมั่นใจในการแก้ปัญหาทางแคลคูลัสและเข้าใจการประยุกต์ใช้ในโลกจริงในสาขาฟิสิกส์, วิศวกรรม, และเศรษฐศาสตร์",
    },
    {
      contentID: "linux01",
      contentName:
        "Linux สำหรับแฮ็กเกอร์จริยธรรม - เรียนรู้พื้นฐานของ Kali Linux",
