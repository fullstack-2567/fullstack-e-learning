...
export default function AdminSidebar({ className }: SidebarProps) {
  ...
  return (
    <div className={cn("flex flex-col h-screen bg-gradient-to-b from-[#606A9B] to-indigo-900 shadow-xl", className)}>
          ...
          <Link to={item.path} key={item.path}>
            <Button
              ...
              className={cn(
                ...
                currentPath === item.path && "bg-indigo-800 text-white shadow-md"
              )}
            >
