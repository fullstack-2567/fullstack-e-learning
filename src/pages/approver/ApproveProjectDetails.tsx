    ...
    return (
        <div className="min-h-screen bg-gray-100 flex flex-col font-prompt">
            ...
            <Dialog open={showRejectDialog} onOpenChange={setShowRejectDialog}>
                <DialogContent>
                    <DialogHeader>
                        <DialogTitle>ยืนยันการปฏิเสธโครงการ</DialogTitle>
                        <DialogDescription>
                            คุณต้องการปฏิเสธโครงการ "{projectData.thaiName}" ใช่หรือไม่?
                        </DialogDescription>
                    </DialogHeader>
                    <div className="py-4">
                        ...
                        <Input
                            id="rejectReason"
                            placeholder="กรุณาระบุเหตุผลในการปฏิเสธโครงการ"
                            className="mt-2"
                            value={rejectReason}
                        ...
                        <DialogDescription>
                            <p>
                                ...
                                {actionCompleted === "อนุมัติ" ? (
                                    ...
                                    <span className="text-red-600 font-bold">ถูกปฏิเสธ</span>
                                )}{" "}
                                โครงการ "{projectData.thaiName}" เรียบร้อยแล้ว
                            </p>
                        </DialogDescription>
                    </DialogHeader>
                    <DialogFooter>
                        <Button className="w-full bg-[#605DEC] hover:bg-[#18167c]" onClick={navigateToProjectMenu}>
