    ...
    useEffect(() => {
        if (searchTerm.trim() === "") {
            ...
            const filtered = projects.filter(
                project =>
                    project.projectThaiName.toLowerCase().includes(searchTerm.toLowerCase()) ||
                    project.projectEngName.toLowerCase().includes(searchTerm.toLowerCase()) ||
                    project.projectSummary.toLowerCase().includes(searchTerm.toLowerCase()) ||
                    getProjectStatus(project).toLowerCase().includes(searchTerm.toLowerCase())
            );
                                            ...
                                            {paginatedProjects.length > 0 ? (
                                                paginatedProjects.map((project, index) => (
                                                    <tr key={project.projectId} className="border-b hover:bg-gray-50">
                                                        ...
                                                        <td className="p-4 w-14 align-top">{startIndex + index + 1}</td>
                                                        <td className="p-4 font-medium align-top">{project.projectThaiName}</td>
                                                        <td className="p-4 text-sm align-top">{project.projectSummary}</td>
                                                        ...
                                                        <td className="p-4 text-sm align-top">
                                                            <Link to={`/approver/project-details/${project.projectId}`}>
